...
Tuwang-tuwa siya sa binigay.
''';

  List<String> words = [];

  final List<int> wordTimings = [
    0, 930, 1860, 2790, 3720,
    4660, 5600, 6540, 7400,
    8280, 9160, 10040, 10920, 11800, 12680, 13560,
    14600, 15640, 16680, 17720, 18760, 19800,
    20900, 22000, 23100, 24200, 25300,
  ];
