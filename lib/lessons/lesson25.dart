...
import 'lesson25_25.dart'; // Updated to import the appropriate next lesson file
...
class _Lesson25State extends State<Lesson25> with WidgetsBindingObserver {
  final String title = 'Aralin 25 ng-'; // Updated the title to "ng-"
  ...
  Future<void> markLessonAsDone(BuildContext context) async {
    ...
    Navigator.pushReplacement(
      context,
      MaterialPageRoute(builder: (context) => Lesson25_25()), // Navigate to the next lesson
    );
  }
  ...
  void _playSound(String word) async {
    ...
    switch (word.toLowerCase()) {
      case 'nga nge ngi ngo ngu':
        audioPath = 'audio/Aralin 25 - nga nge ngi ngo ngu.mp3';
        break;
      case 'nganga':
        audioPath = 'audio/Aralin 25 - nganga.mp3';
        break;
      case 'nguso':
        audioPath = 'audio/Aralin 25 - nguso.mp3';
        break;
      case 'banga':
        audioPath = 'audio/Aralin 25 - banga.mp3';
        break;
      case 'langka':
        audioPath = 'audio/Aralin 25 - langka.mp3';
        break;
      default:
        return;
    }
